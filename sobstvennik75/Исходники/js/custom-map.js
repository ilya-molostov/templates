    ...
    if( document.getElementById('map') != null ){
        $.getScript("objects.js", function(){
            ...
            for (i = 0; i < locations.length; i++) {
				...
				var category = locations[i][8];
				var nophoto = locations[i][10];
				//var docid = locations[i][11];
				//var ob_price = locations[i][2];
                infoboxOptions = {
                    content: boxText,
                    ...
                    closeBoxURL: "assets/templates/rielty/images/close-btn.png",
                ...
                var marker = new MarkerWithLabel({
                    ...
                    map: map,
                    icon: 'assets/templates/rielty/images/marker_1.png',
                ...
                boxText.innerHTML =
                    '<div class="infobox-inner">' +
                        ...
                        '<div class="infobox-title"><a rel="'+ locations[i][11] +'" href="'+ locations[i][5] +'">' + locations[i][0] + '</a></div>' +
				...
				$(document).on('click', '.filters a', function (marker, i, cats) {
					event.preventDefault();
					var thisCat = $(this).attr('data-filtervalue');					
            ...
            var clusterStyles = [
                {
                    url: 'assets/templates/rielty/images/cluster.png',
                    height: 37,
                    width: 37
                }
            ];
